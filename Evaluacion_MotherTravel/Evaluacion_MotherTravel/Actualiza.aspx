<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Actualiza.aspx.cs" Inherits="Evaluacion_MotherTravel.Actualiza" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="margin-top: 20px";>
        ...
        <div>
            <asp:Button ID="btnActualiar" runat="server" Text="Actualiza Factura" CssClass="btn btn-primary btn-sm" OnClick="btnActualiza_Click" />
        </div>
